    ...
    >
      ...
      <div className="space-y-2 p-4">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          {placeName ? (
            <span className="inline-flex max-w-full items-center gap-1 rounded-full bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-600">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,320px)_1fr]">
          ...
          <aside className="space-y-4">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="flex items-center gap-2 rounded-2xl bg-slate-50 px-3 py-2.5 text-slate-500 shadow-inner">
          ...
          <main className="min-w-0">
            {!selectedEntry ? (
              <div className="flex min-h-125 items-center justify-center rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                {selectedPlace?.coverUrl ? (
                  ...
                  <div className="flex h-64 items-center justify-center bg-slate-100 text-slate-300 sm:h-80">
